        ...
        <div className="mx-auto grid max-w-5xl items-center gap-6 lg:grid-cols-2 lg:gap-12">
          <div className="space-y-4">
            ...
            <p className="text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
              ...
              para recomendarte películas que realmente disfrutarás.
            </p>
          </div>
          <ul className="space-y-4 lg:space-y-6">
            <li className="grid grid-cols-[auto_1fr] gap-4">
              ...
              <div className="space-y-1">
                ...
                <p className="text-gray-500 dark:text-gray-400">
                  Inicia sesión en tu cuenta de Movie Matcher para acceder al
            ...
            <li className="grid grid-cols-[auto_1fr] gap-4">
              ...
              <div className="space-y-1">
                ...
                <p className="text-gray-500 dark:text-gray-400">
                  Genera tus selecciones de películas basadas en nuestro proceso
                  para encontrar las mejores coincidencias para ti.
                </p>
              </div>
            </li>
            <li className="grid grid-cols-[auto_1fr] gap-4">
              ...
              <div className="space-y-1">
                ...
                <p className="text-gray-500 dark:text-gray-400">
                  Comparte tus recomendaciones de las películas perfectas para
                  cualquier ocasión. ¡Solo preocupate por disfrutar!
                </p>
              </div>
            </li>
          </ul>
